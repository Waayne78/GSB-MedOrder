...
import heroImage from "../assets/hero-image.jpg"; // Assurez-vous d'avoir cette image
        ...
        <div className="hero-container">
          <div className="hero-content">
            <h1 className="hero-title">
              Commandez vos médicaments <span>facilement</span> et <span>en toute sécurité</span>
            </h1>
            <p className="hero-subtitle">
              GSB MedOrder simplifie la commande de médicaments pour les professionnels de la santé avec une plateforme intuitive et sécurisée.
            </p>
            ...
            <div className="hero-stats">
              <div className="hero-stat">
                ...
                <span className="hero-stat-label">Médicaments disponibles</span>
              </div>
              <div className="hero-stat">
                <span className="hero-stat-number">24h</span>
                <span className="hero-stat-label">Livraison rapide</span>
              </div>
              <div className="hero-stat">
