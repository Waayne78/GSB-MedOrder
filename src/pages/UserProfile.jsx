...
const UserProfile = () => {
  ...
  // Extraire l'utilisateur du state auth
  ...
  const loadUserOrders = async (userId) => {
    try {
      // Vous pouvez décommenter ceci quand votre API sera prête
      // const response = await orderService.getUserOrders(userId);
      // setOrders(response.data);
      
      // En attendant, utilisez les données de test
      setTimeout(() => {
        setOrders([
          {
            id: "CMD-2023-001",
            ...
            items: [
              ...
              { id: 2, name: "Advil", quantity: 1, price: 5.5 },
              { id: 5, name: "Gaviscon", quantity: 1, price: 7.5 },
            ],
          },
          {
            id: "CMD-2023-002",
            ...
            items: [
              ...
              { id: 8, name: "Strepsils", quantity: 1, price: 6.2 },
            ],
          },
        ]);
        setLoading(false);
      ...
      <div className="profile-content">
        <div className="profile-tabs">
          ...
          >
            ...
            >
              <path
                d="M19 3H5C3.9 3 3.01 3.9 3.01 5L3 19C3 20.1 4.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM19 19H5V5H19V19ZM17 12H7V10H17V12ZM14 15H7V13H14V15ZM7 8H17V6H7V8Z"
                fill="currentColor"
              />
            </svg>
            Mes ordonnances
            ...
            <div className="profile-section">
              ...
              {orders.length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  >
                    <path
                      d="M19 5H5C3.89 5 3 5.9 3 7V17C3 18.1 3.89 19 5 19H19C20.11 19 21 18.1 21 17V7C21 5.9 20.11 5 19 5ZM19 17H5V7H19V17ZM17 10H7V8H17V10ZM13 14H7V12H13V14Z"
                      fill="#B0BEC5"
                    />
                  </svg>
          ...
          {activeTab === "prescriptions" && (
            <div className="profile-section">
              ...
              <div className="empty-state">
                ...
                >
                  <path
                    d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2ZM18 20H6V4H13V9H18V20ZM9 13H15V15H9V13ZM9 16H15V18H9V16ZM9 10H11V12H9V10Z"
                    fill="#B0BEC5"
                  />
                </svg>
            ...
            <div className="profile-section">
              ...
              <div className="settings-section">
                ...
                <div className="settings-option">
                  ...
                  <button className="btn-change-password">Modifier</button>
                </div>
                ...
                <div className="settings-option">
                  <div className="option-info">
                    ...
                    <p>
                      Ajouter une couche supplémentaire de sécurité à votre
                      compte
                    </p>
                  </div>
              ...
              <div className="settings-section">
                ...
                <div className="settings-option">
                  <div className="option-info">
                    ...
                    <p>
                      Recevoir des emails concernant vos commandes et mises à
                      jour
                    </p>
                  </div>
                  <label className="switch">
                ...
                <div className="settings-option">
                  <div className="option-info">
                    <h4>Newsletters</h4>
                    <p>
                      Recevoir nos newsletters sur les nouveaux produits et
                      promotions
                    </p>
                  </div>
                  <label className="switch">
              ...
              <div className="danger-zone">
                ...
                <div className="settings-option">
                  ...
                  <button className="btn-delete-account">Supprimer</button>
                </div>
              </div>
            </div>
          )}
