...
import logo from "../assets/logo.jpg"; // Assurez-vous que ce fichier existe
import '../styles/navbar.css'  // Assurez-vous que cette ligne existe
...
const Navbar = () => {
  ...
  // Simuler des données d'authentification provisoires
